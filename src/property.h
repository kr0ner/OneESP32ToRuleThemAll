...
struct Property : public detail::Property {
    ...
    PROPERTY(ZULUFT_SOLL, 0x0597);
    PROPERTY(ZULUFT_IST, 0x0598);
    PROPERTY(ABLUFT_SOLL, 0x0599);
    PROPERTY(ABLUFT_IST, 0x059a);
    PROPERTY(FORTLUFT_SOLL, 0x059b);
    PROPERTY(FORTLUFT_IST, 0x059c);
