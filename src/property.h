...
struct Property : public detail::Property {
    ...
    PROPERTY(WAERMEERTRAG_RUECKGE_TAG_KWH, 0x03b0);
    PROPERTY(WAERMEERTRAG_RUECKGE_SUMME_KWH, 0x03b1);
    PROPERTY(WAERMEERTRAG_RUECKGE_SUMME_MWH, 0x03b6);
    ...
    PROPERTY(AKTIVE_HEIZSTUFEN, 0x05bb); //THZ404
    ...
    PROPERTY(ANZEIGE_HOCHDRUCK, 0x07a6, Type::et_cent_val); //NEU
    PROPERTY(ANZEIGE_NIEDERDRUCK, 0x07a7, Type::et_cent_val); //THZ404
    ...
    PROPERTY(HEISSGAS_TEMP, 0x0265, Type::et_dec_val); //NEU
    PROPERTY(VERFLUESSIGER_TEMP, 0x059c, Type::et_dec_val); //NEU
    PROPERTY(LAUFZEIT_VERDICHTER_HEIZEN, 0x05a4); //NEU
    PROPERTY(LAUFZEIT_VERDICHTER_WW, 0x05a6); //NEU
    PROPERTY(LAUFZEIT_NHZ_HEIZEN, 0x05a8); //NEU
    PROPERTY(LAUFZEIT_NHZ_WW, 0x05a7); //NEU
};
